(function () {
  ...
  function TimeToPensionController(pensionCalculatorService) {
    ...
    $ctrl.yearOfBirth = new Date().getFullYear() - 60;
    $ctrl.monthOfBirth = "6";
    $ctrl.gender = "man";
    ...
    $ctrl.update = function () {
      $ctrl.estimatedYearOfRetirement = pensionCalculatorService.getEstimatedYearOfRetirement(
        $ctrl.yearOfBirth,
        $ctrl.monthOfBirth,
        $ctrl.gender
      );
      $ctrl.timeUntilRetirement = pensionCalculatorService.getTimeUntilRetirement(
        $ctrl.yearOfBirth,
        $ctrl.monthOfBirth,
        $ctrl.gender
      );
      pensionCalculatorService.setGender($ctrl.gender);
    };
